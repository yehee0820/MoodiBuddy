        ...
        return (
            <View style={styles.container}>
                ...
                <View style ={styles.mainDiary}>
                    <View>
                        {/* <Image style={styles.character} source={require('../../assets/images/pokemon.png')}/> */}
                    </View>
                    <View style={styles.charMentContainer}>
                        {/* 캐릭터 멘트가 등장하는 부분 */}
                        <View style={styles.charMent}>
                            <Text style={styles.charText}>오늘도 잘 지나갔네. 고생 많았어! 보고 싶어서 기다렸는데 얼른 얘기해줘~!</Text>
                        </View>
                        <TouchableOpacity
                            style={styles.charButton}
                            onPress={() => navigation.navigate("Chat")}>
                                <Text style={styles.charButtonText}>
                                    기록하러 가기!
                                </Text>
                ...
                <View style ={styles.mainAnalysis}>
                    ...
                    <CalendarStrip style={styles.mainCalendar} customDatesStyles={customDatesStylesFunc}/>
                </View>
                <View style ={styles.mainQuest}>
                    <Text style={styles.questText}>Daily Mission</Text>
                    <Text style={styles.questInfo}>오늘의 미션을 수행하면 기분이 한결 나아질 거예요. Just Do it!</Text>
                    <View style={styles.questBox}>
                        <Text style={styles.questBoxText}>하루가 가기 전에 고마움 표현하기</Text>
                        <CheckBox style={styles.questCheck}/>
                    </View>
                    <View style={styles.questBox}>
                        <Text style={styles.questBoxText}>주말에 뭐 먹을지 행복한 고민하기</Text>
                        <CheckBox style={styles.questCheck}/>
                    </View>
                    <View style={styles.questBox}>
                ...
                <View style ={styles.mainPoint}>
                    <Image style={styles.userLevel} source={require('../../assets/images/treestump.png')}/>
                </View>
